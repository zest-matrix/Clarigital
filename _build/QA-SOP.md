...
| C9 | **A routing page that is thin as well as short** | **METRIC** — settled S94 after being carried open since S87. `kids>=1` answers *is its job routing*, not *is it adequate*. **19 of the 45 HUB pages are under 200 content words** — `codex/history` routes to 8 children on **105 words**, `codex/analytics-cro` to **24 children on 130**. Not a correctness defect; a hub that lists without orienting. *Does not cover:* the 49 SYLLABUS pages, which have not been measured the same way |
...
| C6 | Duplicate or near-duplicate body content | **METRIC** — three sections measured, all clean. **Fintech** max pairwise **6.4%**, **Codex** (333 leaf guides) **7.8%**, both entirely boilerplate. **AI Atlas** (158 pages): **zero pairs share even 4 long sentences** — the cleanest of the three. *Does not cover:* paraphrase, reordered sentences, runs under 8 words, and the two sections not yet measured |
